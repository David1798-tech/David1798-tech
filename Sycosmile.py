#931314 Crackbot 🎵Syco Smile🎵

#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To SycoSmile#80FF00
...
logo = """
  ...
  \033[1;91m:》》》\033[1;93m+2349133934471\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m∞╭──────────•◈•──────────╮∞\033[1;96m-SycoSmile-\033[1;95m∞╭──────────•◈•──────────╮∞
\033[1;92m..........................SycoSmile......................#FF0008
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Niɡeria
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒S  Y  C  O   S  M  I  L  E▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mBlackMafia\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mSycosmile3333
\033[1;94mSycoSmile\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mSycosmile3333
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+2349133934471
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mBlackMafia\033[1;95m∞╰──────────•◈•──────────╯∞"""
jalan('              \033[1;96m....................SYCOSMILE.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin SYCOSMILE\033[1;95m∞╰──────────•◈•──────────╯∞"

CorrectUsername = "Syco"
CorrectPassword = "Smile"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:SYCOSMILE
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m∞──────────•◈•──────────∞\033[1;96mSYCOSMILE\033[1;95m∞──────────•◈•──────────∞"
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95m♡──────────•◈•──────────∞\033[1;96mSYCO\033[1;95m∞──────────•◈•──────────╯∞"
		try:
	...
	jalan(' \033[1;93m ........Cloning Start pls Wait.......... ')
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mSyco\033[1;95m∞──────────•◈•──────────∞"
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mSYCOSMILE\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By SYCO---•◈•---»" #Dev:SYCO-SMILE
